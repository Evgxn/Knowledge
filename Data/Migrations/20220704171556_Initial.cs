    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("2ea08c6e-bb67-4e5e-9986-1be063ce4ff5"), "Пользователь" });

            migrationBuilder.InsertData(
                table: "Roles",
                columns: new[] { "Id", "RoleName" },
                values: new object[] { new Guid("7f82efcf-d593-40cb-a9ce-255069b8a397"), "Администратор" });
